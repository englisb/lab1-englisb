...
//=================Question 2================================
    ...
    void TestQ2_corner(CuTest *tc) {					//my test case
...
*/
    ...
    void TestQ3_0_grade(CuTest *tc) {				//my test case
...
//=================Question 4================================ 
    ...
    void TestQ4_0(CuTest *tc) {					//my test case
    	int input = 0;
        double actual = Q4(input);
        double expected = 0;
        CuAssertDblEquals(tc, expected, actual,0);
...
//=================Question 6================================   
    ...
    void TestQ6_1(CuTest *tc) {			//my test case
        int input = 1;
        int expected[100]={0},actual[100]={0};
        int expectedCount=0;
        int actualCount = Q6(input,actual);
...
//=================Question 7================================  
    ...
    void TestQ7b_3(CuTest *tc) {		//my test case
            int input = 120340560;
            int actual = Q7b(input);
            int expected = 65043021;
            CuAssertIntEquals(tc, expected, actual);
    }

    void TestQ7a_3(CuTest *tc) {		//my test case
    	int input = 1203405;
        int actual = Q7b(input);
        int expected = 5043021;
        CuAssertIntEquals(tc, expected, actual);
    }
